...
export default function Edit() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        name: nameDevice.name,
        status: nameDevice.status,
        image: null as File | null,
        _method: 'PUT',
    });

    const [imagePreview, setImagePreview] = useState<string | null>(
        nameDevice.image ? `/storage/${nameDevice.image}` : null
    );
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('name-devices.update', nameDevice.id), {
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <AppLayout>
            <Head title={`Edit ${nameDevice.name}`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Device Name</h1>
                        <p className="text-muted-foreground">
                            Update "{nameDevice.name}" information
                        </p>
                    </div>
                </div>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <ul className="text-sm text-muted-foreground space-y-1">
                                        ...
                                        <li>• Leave empty to keep current</li>
                                    </ul>
                                </div>
