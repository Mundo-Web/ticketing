<?php
/**
 * SCRIPT DE EMERGENCIA PARA CONFIGURAR EL WEBHOOK SIN FIRMA
 * Ejecutar este archivo en el servidor de producción para permitir webhooks sin firma
 */
...
echo "🚨 CONFIGURANDO WEBHOOK SIN VALIDACIÓN DE FIRMA\n";
echo "📍 Esto es temporal para que funcione NinjaOne\n\n";

// Crear controlador temporal con validación deshabilitada
...
// Escribir el archivo
$controllerPath = app_path('Http/Controllers/Api/NinjaOneWebhookController.php');
...
// Escribir nuevo controlador
file_put_contents($controllerPath, $controllerContent);
echo "✅ Controlador actualizado sin validación de firma\n";
...
echo "📋 Ahora el webhook debería funcionar sin problemas\n";
echo "🔍 Para revertir, usa el backup: " . basename($backupPath) . "\n";
